...
class Offre
{
    ...
    public function setQualifications( $qualifications): void { $this->qualifications = $qualifications; }
    public function setLieu( $lieu){ $this->lieu = $lieu; }
    public function setRecruteur(Recruteur $recruteur) { $this->recruteur = $recruteur; }
